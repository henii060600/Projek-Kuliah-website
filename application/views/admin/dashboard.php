            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  ...
                  <div class="card-body">
                    <?php echo $total_data['total_motor']; ?>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <?php foreach ($transaksi as $tr) : ?>
                      <li class="media">
                        <div class="media-body">
                          ...
                          <div class="media-title"><?php echo $tr->nama_user ?></div>
                          <span class="text-small text-muted text-bold">
                            Rental motor <?php echo $tr->nama_motor ?>
                            dari tanggal <?php echo date('d/m/Y', strtotime($tr->tgl_rental ))?>
                            sampai <?php echo date('d/m/Y', strtotime($tr->tgl_kembali ))?>.
                          </span> <br>
