                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <img width="70" src="<?php echo base_url() ?>assets/upload/scooter.png">
                                <p>Web Sewa Motor Motorun adalah sebuah marketplace untuk penyedia rental kendaaraan roda dua.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> Jl. Mampang Prapatan II</li>
                                    <li><i class="fa fa-mobile"></i> +62 8999 1234</li>
                                    <li><i class="fa fa-envelope"></i> layanan@.com</li>
                                </ul>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <div class="scroll-top">
        <img width="50px" src="<?php echo base_url() ?>assets/upload/rider.png" alt="JSOFT">
    </div>
    <!--== Scroll Top Area End ==-->
