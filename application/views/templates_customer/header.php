                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 bold">
                        <a href="<?php echo base_url('dashboard') ?>" class="logo">
                            <img width="60px" src="<?php echo base_url() ?>assets/upload/scooter.png" alt="JSOFT">MOTORUN 
                        </a>
                        ...
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <?php if($this->session->userdata('nama_user')) { ?>
                                    ...
                                    <li><a class="text-warning">Halo, <?php echo $this->session->userdata('nama_user') ?></a></li>
